...
The author now shows a 12-line code example.
...
Image: During the first wave, APIs were largely aimed at third parties who'd use them to extend and augment the underlying platform to provide additional features for users..
...
Image: In the second wave, APIs map cleanly to normal product capabilities. They provide programmatic access for agents that act on behalf of people..
...
-   Salesforce introduced their “Headless 360” initiative, which purports to have made every Salesforce feature accessible by API, MCP, or CLI command.
