...
source: https://brandur.org/second-wave-api-first
---
...
![During the first wave, APIs were largely aimed at third parties who'd use them to extend and augment the underlying platform to provide additional features for users.](https://brandur.org/assets/images/second-wave-api-first/first-wave.svg)
...
![In the second wave, APIs map cleanly to normal product capabilities. They provide programmatic access for agents that act on behalf of people.](https://brandur.org/assets/images/second-wave-api-first/second-wave.svg)
