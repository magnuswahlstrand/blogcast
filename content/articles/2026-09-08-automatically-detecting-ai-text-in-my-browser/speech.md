...
Published September eighth, twenty twenty-six.
...
A table with columns: Model / variant, Human falsely flagged, AI-involved text caught. Model / variant: Gradient — MLX 4-bit; Human falsely flagged: 2.712%; AI-involved text caught: 52.35%. Model / variant: EditLens RoBERTa-large — community INT8; Human falsely flagged: 2.484%; AI-involved text caught: 56.06%. Model / variant: Vanguard; Human falsely flagged: 2.267%; AI-involved text caught: 44.92%. Model / variant: Desklib; Human falsely flagged: 3.008%; AI-involved text caught: 45.04%. Model / variant: Raschka DistilBERT; Human falsely flagged: 2.598%; AI-involved text caught: 39.01%. Model / variant: Raschka Qwen3-0.6B; Human falsely flagged: 2.028%; AI-involved text caught: 28.67%. Model / variant: Raschka ModernBERT; Human falsely flagged: 1.698%; AI-involved text caught: 21.58%. Model / variant: TMR / Oxidane — INT8; Human falsely flagged: 1.595%; AI-involved text caught: 19.35%.
...
Quote: As with most modern language model engineering, a ReAct agent can also see massive sudden improvements by swapping out the underlying model for a better one. … I think this is another reason to invest in agents like this early, in order to take advantage of more powerful models as they come out.
...
1.  Substack kind of has this already, although you have to click a button to scan the post.
