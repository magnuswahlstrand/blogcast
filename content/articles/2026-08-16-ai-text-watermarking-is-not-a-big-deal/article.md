...
### Watermarked text is not lower-quality[](#watermarked-text-is-not-lower-quality)
...
1.  Interestingly, this [might be](https://www.reddit.com/r/asklinguistics/comments/apes6p/comment/eg7sife/) very slightly even-favored.
    ...
    [↩](#fnref-1)
2.  I am not sponsored by Pangram. As I understand it, Pangram is by far the best AI-detection tool right now (in part because many of its competitors are shady and [exist to promote](https://www.seangoedecke.com/ai-detection/) paid “AI-detection-evasion” services).
    
    [↩](#fnref-2)
3.  Technically, this is called a “zero-bit watermark”, because you can’t recover a yes-or-no value from the watermark itself (merely from the *presence* of a watermark).
