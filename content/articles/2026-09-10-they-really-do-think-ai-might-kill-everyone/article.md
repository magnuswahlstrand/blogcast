...
### How AI could kill everyone[](#how-ai-could-kill-everyone)
...
Why would you work in AI, if you believe this? Why wouldn’t you go live in the woods somewhere, or start [bombing datacenters](https://www.seangoedecke.com/luddites-and-ai-datacenters/), or [assassinating](https://www.theguardian.com/technology/2026/apr/18/sam-altman-house-attack-ai) AI lab CEOs? For a few reasons.

An AI powerful enough to end humanity is an AI powerful enough to save it. I wrote about this in [*Help peer*](https://www.seangoedecke.com/help-peer/): many AI researchers believe that the only way for humanity to truly survive long-term is with the help of superintelligent AIs, so long as someone can figure out alignment.
...
Why does it matter who’s first? Some popular theories of AI development involve a [“foom”](https://www.reddit.com/r/singularity/comments/12bisxu/what_does_foom_stand_for_who_coined_this_term/) or “hard takeoff”: the first time someone really cracks self-improving AI, capabilities will increase exponentially, because smart AI will be better able to make itself smarter, *ad infinitum*[7](#fn-7). **There are no draws in the AI race**. The first lab to figure out smart human-like intelligence will be the first one to figure out wildly superhuman intelligence, and thus will be in a position to stop anyone else from doing it.
