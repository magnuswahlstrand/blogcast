...
Published September thirteenth, twenty twenty-six.
...
This is kind of like Goodhart’s Law. Puzzles were a useful, impossible-to-game measure for mathematical progress. But now that AI companies can game that measure (by solving them in a way that’s inaccessible to humans), the whole point of those puzzles disappears.
